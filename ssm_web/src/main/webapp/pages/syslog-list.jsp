				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:if test="${currentPage!=1}">
								<li><a href="../sysLog/findAll.do?page=${currentPage-1}&size=10">上一页</a></li>
							</c:if>



							<c:forEach var="page" begin="1" end="${pages}">
								<li><a href="../sysLog/findAll.do?page=${page}&size=10">${page}</a></li>
							</c:forEach>
							...
							<c:if test="${currentPage!=pages}">
								<li><a href="../sysLog/findAll.do?page=${currentPage+1}&size=10">下一页</a></li>
							</c:if>
